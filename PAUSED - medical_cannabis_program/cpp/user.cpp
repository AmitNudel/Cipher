...
void User::ShowAllWeedAvailable(std::string weed_type)
{
...
void User::BuyWeed(std::string weed_type, std::string weed_dosage, std::string weed_kind, int amount, Shop& shop)
{
